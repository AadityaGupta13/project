		              ...
		              <div class="row content-row">
		                <div class="col-xs-12 col-sm-6 service-content">
		                  <div class="media">
		                    ...
		                    <div class="media-body">
		                      <h3 class="media-heading">Logo &amp; Graphic Design</h3>
		                      <p>We all want to make a good first impression, and hopefully a lasting one too! By understanding your company’s audience, values and goals, we produce logo designs.</p>
		                ...
		                <div class="col-xs-12 col-sm-6 service-content">
		                  <div class="media">
		                    ...
		                    <div class="media-body">
		                      <h3 class="media-heading">Search Engine Optimisation</h3>
		                      <p>We all want to make a good first impression, and hopefully a lasting one too! By understanding your company’s audience, values and goals, we produce logo designs.</p>
					    ...
					    <div class="row text-center circle-connector">
					      	<div class="col-xs-6 col-sm-3">
					       		<div class="process-circle wow zoomIn">
					          		<a href="#"><img src="img/met.png" alt=""></a>
					          		<span>Meet</span>
					        	</div><!-- /.circle -->
					      	</div><!-- /.col-sm-3 -->
					      	<div class="col-xs-6 col-sm-3">
					       		<div class="process-circle wow zoomIn">
					          		<a href="#"><img src="img/met2.png" alt=""></a>
					          		<span>Research</span>
					        	</div><!-- /.circle -->
					      	</div><!-- /.col-sm-3 -->
					      	<div class="col-xs-6 col-sm-3">
					       		<div class="process-circle wow zoomIn">
					          		<a href="#"><img src="img/met3.png" alt=""></a>
					          		<span>Cultivate Ideas</span>
					        	</div><!-- /.circle -->
					      	</div><!-- /.col-sm-3 -->
					      	<div class="col-xs-6 col-sm-3">
					       		<div class="process-circle wow zoomIn">
					          		<a href="#"><img src="img/met4.png" alt=""></a>
						      ...
						      <div class="modal-body">
						        <div class="row">
						        	<div class="col-md-6 col-xs-12">
						        		<img class="img-responsive" src="img/work/portfolio-1.jpg" alt="">
						        	</div>
						        	<div class="col-md-6">
						        		<div class="portfolio-details">
						        			<h3>Portfolio Title</h3>
						        			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia, omnis illo iste ratione. Numquam eveniet quo, ullam itaque expedita impedit. Eveniet, asperiores.</p>
						        			<strong>Client: <a href="#">Themehippo</a></strong> <br>
						        			<strong>Service: Web Development</strong> <br>
		        	...
		        	<div class="css-overlay section-padding">
			        	<div class="container">
							<div class="row text-center">
						        ...
						        <div class="col-xs-12 col-sm-3">
						          <strong><span class="timer">31260</span>+</strong>
						          <span class="count-description">Work hour</span>
						        </div><!-- /.col-sm-3 -->
						        <div class="col-xs-12 col-sm-3">
						          <strong><span class="timer">3860</span>+</strong>
						          <span class="count-description">Work hour</span>
						        </div><!-- /.col-sm-3 -->
					      	</div>
			        	</div><!-- /.container -->
		        ...
		        <section id="blog" class="blog-section section-padding">
			        <div class="container">
							...
							<div class="col-sm-6 col-md-4">
								<article class="blog-post-wrapper">
									<header class="entry-header">
										...
										<h2 class="entry-title"><a href="blog-single.php">Competently fabricate progressive niches via cross-unit relationships.</a></h2>
									</header><!-- /.entry-header -->
									...
									<div class="post-thumbnail">
										...
										<div class="entry-footer clearfix">
								            <ul class="list-inline pull-left">
								       		...
								       		<a class="readmore pull-right" href="blog-single.php"><i class="fa fa-plus"></i></a>
										</div><!-- /.entry-footer -->
									</div><!-- /.post-thumbnail -->
								</article>
					      	</div><!-- /.col-md-4 -->
						...
						<div class="more-post text-center">
				        	<a href="blog.php" class="btn btn-primary btn-lg">More Blog Post</a>
				        </div>
